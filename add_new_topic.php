...
if($result){
echo "<div style='padding-left:520px;'><h1>Sujet ajouté avec Succées</h1></div><BR>";
echo "<div style='padding-left:620px;'><a href=main_forum.php>Voir votre Sujet</a></div>";
}
else {
echo "ERROR";
}
